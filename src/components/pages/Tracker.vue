...
<div>
  ...
  <div class="columns download has-text-centered">
    <div class="column">
      ...
      <a class="button" href="/card17-tracker-windows.zip"><span class="icon"><i class="fa fa-download"></i></span><span>Download v1.0.3</span></a>
      <br><br>
    ...
    <div class="column">
      ...
      <a class="button" href="/card17-tracker-osx.zip"><span class="icon"><i class="fa fa-download"></i></span><span>Download v1.0.3</span></a>
      <br><br>
      <p>
        <span class="tag is-warning is-small">{{ $t('tracker.nota') }}</span>
