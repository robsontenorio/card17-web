...
<div>
  ...
  <progress-bar :percent="98" type="success" :showinfo="true"></progress-bar>
  ...
  <p><span class="icon"><i class="fa fa-check-square-o "></i></span> Colocar decks recém usados no topo</p>
