const messages = {
  ...
  problemas_info: '- Does not work on PANDORA MODE.<BR><BR>- Cards that creates RANDOM cards can mess up the DECKTRACKER counting when they are played (eg, Spellwhirl).<br><br>- If the connection is lost or the game is closed, restart the procedure: Close the FAERIA, close the TRACKER. Open the TRACKER, open the FAIRY. Of course, you can finish your match first before closing!<br><br>- Decks created during the session are not recognized immediately by the DECKTRACKER (you must restart the procedure). Edited decks are recognized normally.<br><br>- Works locally and does not send data to CARD17 ... for now.',
  entendi: 'Ok, I got it ...',
  nota: 'note',
