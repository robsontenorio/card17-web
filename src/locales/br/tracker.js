const messages = {
  ...
  problemas_info: '- Não funciona no modo PANDORA.<br><br>- Caso a conexão seja perdida ou o jogo seja fechado abruptamente, o DECKTRACKER voltará a rastrear somente na próxima partida.<br><br>- Decks criados durante a sessão não são reconhecidos imediatamente pelo DECKTRACKER (você deve reiniciar o FAERIA). Decks editados são reconhecidos normalmente.<br><br>-Funciona localmente e não envia os dados ao CARD17...por enquanto.',
  entendi: 'Ok, entendi ...',
  nota: 'nota',
